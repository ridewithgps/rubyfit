...
class RubyFit::MessageWriter
  ...
  MESSAGE_DEFINITIONS = {
    ...
    session: {
      ...
      fields: {
        timestamp: { id: 253, type: RubyFit::Type.timestamp },
        start_time: { id: 2, type: RubyFit::Type.timestamp },
        start_position_lat: { id: 3, type: RubyFit::Type.sint32 },
        start_position_long: { id: 4, type: RubyFit::Type.sint32 },
        total_elapsed_time: { id: 7, type: RubyFit::Type.sint32 },
        total_timer_time: { id: 8, type: RubyFit::Type.sint32 },
        total_distance: { id: 9, type: RubyFit::Type.sint32 },
        total_cycles: { id: 10, type: RubyFit::Type.sint32 },
        nec_lat: { id: 29, type: RubyFit::Type.sint32 },
        nec_long: { id: 30, type: RubyFit::Type.sint32 },
        swc_lat: { id: 31, type: RubyFit::Type.sint32 },
        swc_long: { id: 32, type: RubyFit::Type.sint32 },
        avg_stroke_count: { id: 41, type: RubyFit::Type.uint32 },
        total_work: { id: 48, type: RubyFit::Type.uint32 },
        total_moving_time: { id: 59, type: RubyFit::Type.uint32 },
        time_in_hr_zone: { id: 65, type: RubyFit::Type.uint32 },
        time_in_speed_zone: { id: 66, type: RubyFit::Type.uint32 },
        time_in_cadence_zone: { id: 67, type: RubyFit::Type.uint32 },
        time_in_power_zone: { id: 68, type: RubyFit::Type.uint32 },
        avg_lap_time: { id: 69, type: RubyFit::Type.uint32 },
        enhanced_avg_speed: { id: 124, type: RubyFit::Type.uint32 },
        enhanced_max_speed: { id: 125, type: RubyFit::Type.uint32 },
        enhanced_avg_altitude: { id: 126, type: RubyFit::Type.uint32 },
        enhanced_min_altitude: { id: 127, type: RubyFit::Type.uint32 },
        enhanced_max_altitude: { id: 128, type: RubyFit::Type.uint32 },
        ...
        avg_altitude: { id: 49, type: RubyFit::Type.uint16 },
        max_altitude: { id: 50, type: RubyFit::Type.uint16 },
        ...
        min_altitude: { id: 71, type: RubyFit::Type.uint16 },
